...
<head>
	...
	<style>
		@import url('https://fonts.googleapis.com/css?family=Montserrat:700|Open+Sans|Roboto');
	</style>
				...
				<table width="650" border="0" cellspacing="0" cellpadding="0" class="mobile-shell">
					<tr>
						<td class="td container" style="width:650px; min-width:650px; font-size:0pt; line-height:0pt; margin:0; font-weight:normal; padding:55px 0px;">
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<th class="column-top" width="100%" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; vertical-align:top;">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td class="img m-center" style="font-size:0pt; line-height:0pt;"><img src="https://res.cloudinary.com/cofnderscloud/image/upload/v1556098402/xjkinqjduernmx7fxcsw.png"  height="90" border="0" alt="" /></td>
														</tr>
													</table>
												</th>
							...
							<!-- Intro -->
							<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#DDF0FF">
								<tr>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td class="p30-15" style="padding: 60px 30px;">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td class="h1 pb25" style="color:#000000; font-family:'Montserrat', sans-serif; font-size:30px; line-height:46px; text-align:center; padding-bottom:25px;">Hello ${name},</td>
														</tr>
														<tr>
...
<tr>
                                                        ...
                                                        <tr>
															<td class="text-center pb25" style="color:#666666; font-family:'Open Sans', sans-serif; font-size:16px; line-height:30px; text-align:left; padding-bottom:25px;">Based on todays feedback we came up with two projects which will help us in evaluating your skills. You can check the project guidelines on: https://bit.ly/2xx74eF (Front End Web App), https://bit.ly/2S1bYdh (Backend Server).
                                                        </tr>
                                                        <tr>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td align="center" style="padding-bottom: 30px;">
													...
													<tr>
														<td class="img" width="55" style="font-size:0pt; line-height:0pt; text-align:left;"><a href="https://www.facebook.com/opscaleindia/" target="_blank"><img src="https://res.cloudinary.com/cofnderscloud/image/upload/v1554730654/t2_facebook.jpg" width="34" height="34" border="0" alt="" /></a></td>
														<td class="img" width="55" style="font-size:0pt; line-height:0pt; text-align:left;"><a href="https://twitter.com/opscaleindia" target="_blank"><img src="https://res.cloudinary.com/cofnderscloud/image/upload/v1554730654/t2_twitter.jpg" width="34" height="34" border="0" alt="" /></a></td>
														<td class="img" width="34" style="font-size:0pt; line-height:0pt; text-align:left;"><a href="https://www.linkedin.com/company/opscaleindia/" target="_blank"><img src="https://res.cloudinary.com/cofnderscloud/image/upload/v1554730654/t2_linkedin.jpg" width="34" height="34" border="0" alt="" /></a></td>
													</tr>
													</table>
												</td>
											</tr>
											<tr>
												<td class="text-footer1 pb10" style="color:#999999; font-family:'Muli', Arial,sans-serif; font-size:14px; line-height:20px; text-align:center; padding-bottom:10px;">Opscale | Startup Engineering </td>
											</tr>
										</table>
									</td>
								</tr>
